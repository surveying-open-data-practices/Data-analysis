...
# this function is for plotting the multiple choice grid (table) question Q18 combined with a demographic.
...
plotMultiChoiceGrid2var_Q18 <- function(questionName, demographic) {
   ...
   name_two <- mcg_key[[2]][1,3] # 'a's or before research...
...
#plotMultiChoiceGrid2var_Q18("Who is typically given access to data produced by your research pre- and post-publication?", "Age")
