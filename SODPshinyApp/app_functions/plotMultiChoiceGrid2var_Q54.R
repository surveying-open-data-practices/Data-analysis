...
# this function is for plotting the multiple choice grid (table) question Q54 combined with a demographic.
...
#plotMultiChoiceGrid2var_Q54("When considering your research activities do you have:", "Age")
